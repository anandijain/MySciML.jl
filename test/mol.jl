...
@named pdesys = PDESystem(eq, bcs, domains, [x, y, t], [u(x, y, t), v(x, y, t)], [xmin, xmax])
N = 32
...
states(pdesys)
propertynames(pdesys)


@parameters t sig = 10 rho = 28.0 beta = 8 / 3
@variables x(t) = 100 y(t) = 1.0 z(t) = 1 u(t) = 0 [irreducible = true]
D = Differential(t)
...
@test isempty(observed(ssys))
prob = ODEProblem(ssys; jac=true, cse=true)
